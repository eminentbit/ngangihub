...
import { FaUsers, FaCalendarAlt, FaMoneyBillWave, FaRegClock } from 'react-icons/fa';
          ...
          <div className="max-auto mx-auto">
            ...
            <section>
              ...
              <div className="sm:hidden space-y-4">
                {recentActivities.map(act => (
                  <div key={act.id} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                    <div className="flex justify-between mb-2">
                      <span className="font-semibold text-blue-600 dark:text-blue-300">{act.type}</span>
