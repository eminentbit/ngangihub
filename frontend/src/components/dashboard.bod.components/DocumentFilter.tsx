...
const DocumentFilter: React.FC<DocumentFilterProps> = ({ filter, setFilter }) => {
        ...
        {categories.map(c => (
          <button
            ...
            style={{
              ...
              backgroundColor: filter.category === c ? '#9333ea' : (isDarkMode ? '#4b5563' : '#e5e7eb'),
              color: filter.category === c ? 'white' : (isDarkMode ? 'white' : 'black'),
              border: 'none',
              borderRadius: '4px',
              cursor: 'pointer',
