...
const SubscriptionModal = ({ onClose, onSubscribe }: SubscriptionModalProps) => {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: ["Create unlimited groups", "Advanced analytics", "Priority support", "Custom branding"],
    },
  ]
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-2xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          {plans.map((plan) => (
            ...
            >
              ...
              <p className="text-2xl font-bold mb-3">{plan.price.toLocaleString()} CFA</p>
          ...
          <div className="mb-6 border dark:border-gray-700 rounded-lg p-4">
            <div className="grid grid-cols-1 gap-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                You will receive a payment confirmation code on this number to complete your subscription.
              </p>
            </div>
          </div>
        )}
        ...
        {paymentMethod === "bank" && (
          <div className="mb-6 border dark:border-gray-700 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              After making the transfer, please enter your transaction reference below:
            </p>
            <input
              type="text"
        ...
        <div className="flex justify-end gap-3">
          ...
          <button className="btn btn-primary flex items-center gap-2" onClick={handleSubscribe} disabled={isProcessing}>
            {isProcessing ? (
              <>
                <svg
